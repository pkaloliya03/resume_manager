                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="detail-box">
                                    ...
                                    <p>
                                        Connect with top recruiters and accelerate your career with verified job
                                        listings.
                                    </p>
                                    <div class="btn-box">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <br>
                        <p>
                            EduNeuroHRx is a platform that connects job seekers with employers. We provide a platform
                            for job seekers to find jobs and for employers to find the right candidates. We are
                            committed to providing the best job opportunities to job seekers and the best candidates to
                            employers. We are dedicated to helping job seekers find the right job and employers find the
                            right candidate.
                        </p>
                        <br>
                        <a href="{{ route('about') }}">
