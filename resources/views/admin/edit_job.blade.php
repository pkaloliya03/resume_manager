    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.jobs.update', $job->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="company_name" value="{{ $job->company_name }}" class="w-full p-2 border rounded"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="education" value="{{ $job->education }}" class="w-full p-2 border rounded"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="experience" value="{{ $job->experience }}" class="w-full p-2 border rounded"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="location" value="{{ $job->location }}" class="w-full p-2 border rounded"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="required_skills" value="{{ $job->required_skills }}"
                    class="w-full p-2 border rounded" placeholder="E.g., Laravel, PHP, ReactJS" required>
            </div>

            <!-- Last Date to Apply -->
            <div class="mb-4">
                <label class="block text-gray-700">Last Date to Apply</label>
                <input type="date" name="last_date_to_apply" value="{{ $job->last_date_to_apply }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="hr_contact_name" value="{{ $job->hr_contact_name }}"
                    class="w-full p-2 border rounded" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="email" name="hr_email" value="{{ $job->hr_email }}" class="w-full p-2 border rounded"
                    required>
            </div>
